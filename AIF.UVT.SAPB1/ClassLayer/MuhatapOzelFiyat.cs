...
{
    public class MuhatapOzelFiyat
    {
        [ItemAtt(AIFConn.MuhatapicinOzelFiyatlar_FormUID)]
        public SAPbouiCOM.Form frmMuhatapicinOzelFiyatla;
        ...
        public void LoadForms()
        {
            ...
            {
                Functions.CreateUserOrSystemFormComponent<MuhatapOzelFiyat>(AIFConn.Sys668, true, formuid);
        ...
        public bool SAP_ItemEvent(string FormUID, ref ItemEvent pVal, ref bool BubbleEvent)
        {
            ...
            switch (pVal.EventType)
            {
                ...
                case BoEventTypes.et_FORM_LOAD:
                    ...
                    {
                        frmMuhatapicinOzelFiyatla = Handler.SAPApplication.Forms.Item(pVal.FormUID);
                        //frmInit = false; 
                        formuid = pVal.FormUID;
                        AIFConn.Sys668.LoadForms();
                        OzelFiyatlarOlcut.baseForm = frmMuhatapicinOzelFiyatla;
                    }
                    break;
                case BoEventTypes.et_FORM_UNLOAD:
                    break;
