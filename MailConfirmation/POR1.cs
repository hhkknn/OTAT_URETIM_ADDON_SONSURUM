...
namespace MailConfirmation
{
    ...
    public partial class POR1
    {
        ...
        public Nullable<int> StdItemId { get; set; }
        public Nullable<int> CommClass { get; set; }
        public Nullable<int> U_AIF_DiscountNo { get; set; }
        public Nullable<decimal> U_Iskonto1 { get; set; }
        public Nullable<decimal> U_Iskonto2 { get; set; }
        public Nullable<decimal> U_Iskonto3 { get; set; }
        public Nullable<decimal> U_Iskonto4 { get; set; }
        public Nullable<decimal> U_Iskonto5 { get; set; }
        public Nullable<int> U_SSDocEntry { get; set; }
        public Nullable<int> U_SSLineNum { get; set; }
        public Nullable<int> U_SSDocType { get; set; }
    }
}
