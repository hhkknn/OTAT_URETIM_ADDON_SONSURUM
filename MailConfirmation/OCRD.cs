...
namespace MailConfirmation
{
    ...
    public partial class OCRD
    {
        ...
        public string U_FaturaSenaryosu { get; set; }
        public string U_GonderimSekli { get; set; }
        public string U_MukellefTipi { get; set; }
        public string U_OldErpCode { get; set; }
        public string U_OzelKod1 { get; set; }
        public string U_OzelKod2 { get; set; }
        public string U_Ownership { get; set; }
        public string U_LegalProceed { get; set; }
        public string U_TakipTuru { get; set; }
        public string U_Avukat { get; set; }
        public Nullable<System.DateTime> U_DavaBasTar { get; set; }
        public Nullable<System.DateTime> U_DavaBit { get; set; }
        public string U_Nitelik { get; set; }
        public string U_CommarchKod { get; set; }
        public string U_CommarchAltKod { get; set; }
    }
}
