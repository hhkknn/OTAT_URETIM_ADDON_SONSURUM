...
namespace MailConfirmation
{
    ...
    public partial class ORDR
    {
        ...
        public string U_AracPlakasi { get; set; }
        public string U_SoforAdi { get; set; }
        public Nullable<decimal> U_AracSicakligi { get; set; }
        public string U_GonderimTipi { get; set; }
        public string U_RotaCode { get; set; }
        public string U_BatchNumber { get; set; }
        public string U_KullaniciId { get; set; }
        public string U_SutKabulId { get; set; }
        public Nullable<int> U_SSDocEntry { get; set; }
        public string U_OnayRed { get; set; }
        public string U_YonIslmSaat { get; set; }
        public Nullable<System.DateTime> U_YonIslmTar { get; set; }
        public string U_OnaylayanYon { get; set; }
        public string U_IndirimTipi { get; set; }
        public Nullable<decimal> U_TopSutMiktari { get; set; }
        public string U_SutKabulIrsNo { get; set; }
        public string U_KantarNo { get; set; }
        public string U_CommarchOrderNo { get; set; }
        public string U_UretimdenGonderildi { get; set; }
        public string U_PaymentDBS { get; set; }
        public Nullable<decimal> U_TotalPriceDBS { get; set; }
        public string U_DBSJournalEntryNo { get; set; }
        public string U_DBSAcctCode { get; set; }
        public string U_BackStockQty { get; set; }
        public string U_DocumentType { get; set; }
    }
}
